...
public:
    ...
    BayesC(const Data &data, const float varGenotypic, const float varResidual, const float pival, const bool estimatePi, const bool noscale,
...
public:
    ...
    BayesC(data, varGenotypic, varResidual, pis[0], estimatePi, false, "Gibbs", false),
    Pis(pis),
...
public:
    ...
    BayesS(const Data &data, const float varGenotypic, const float varResidual, const float pival, const bool estimatePi, const float varS, const vector<float> &svalue,
           const string &algorithm, const bool message = true):
    BayesC(data, varGenotypic, varResidual, pival, estimatePi, true, "Gibbs", false),
...
//    BayesC::ResidualVar vare;
    ...
    ApproxBayesC(const Data &data, const float varGenotypic, const float varResidual, const float pival, const bool estimatePi, const bool noscale, const bool message = true)
    : BayesC(data, varGenotypic, varResidual, pival, estimatePi, noscale, "Gibbs", false)
    , data(data)
    , rcorr(data.ZPy)
...
public:
    ...
    ApproxBayesR(const Data &data, const float varGenotypic, const float varResidual, const VectorXf pis, const VectorXf gamma, const bool estimatePi, const bool noscale,
                 const bool message = true):
    ApproxBayesC(data, varGenotypic, varResidual, (1-pis[0]), estimatePi, noscale, false),
    Pis(pis),
    gamma(gamma, vector<string>(gamma.size())),
    varg(varGenotypic, data.numKeptInds),
    snpEffects(data.snpEffectNames),
...
public:
    ...
    ApproxBayesKappa(const Data &data, const float varGenotypic, const float varResidual, const VectorXf pis, const VectorXf gamma, const bool estimatePi, const float kappa_str,
                     const bool noscale, const bool message = true):
    ApproxBayesC(data, varGenotypic, varResidual, (1-pis[(gamma.size()-1)]), estimatePi, noscale, false),
    Pis(pis),
    gamma(gamma, vector<string>(gamma.size())),
    kappa(kappa_str),
    varg(varGenotypic, data.numKeptInds),
