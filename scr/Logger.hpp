...
#ifndef GCTA2_LOGGER_HPP
#define GCTA2_LOGGER_HPP
...
public:
    ...
    void close();
    void flush();
    /// Tee std::cout/std::cerr: log file is a byte-identical copy of console output.
    void attachStdout();
    void restoreStdout();
    static bool stdoutIsAttached();
...
private:
    ...
    bool check();
    void LogUnlocked(int level, Type type, const string& prompt, const string& message);
    static Type m_stat;
    static string m_FileName;
    static Logger* m_pThis;
    static std::ofstream m_logFile;
    static std::streambuf* s_savedCoutBuf;
    static std::streambuf* s_savedCerrBuf;
    static std::streambuf* s_coutTeeBuf;
    static std::streambuf* s_cerrTeeBuf;
};

#endif //GCTA2_LOGGER_HPP
