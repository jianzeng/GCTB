...
//    void makeLDmatrix(const string &bedFile, const unsigned windowWidth, const string &filename);
    ...
    void makeshrunkLDmatrix(const string &bedFile, const string &LDmatType, const string &snpRange, const string &filename, const float effpopNE, const float cutOff, const float genMapN);
    ...
    void buildSparseMME(const string &bayesType, const bool noscale);
